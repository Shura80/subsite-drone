...
Feature: ENRD Events
  ...
  Scenario: View the "Upcoming events" block on the "News & Events" page.
    ...
    Then I should see the ".online" element in the "right content" region
  ...
  Scenario: Check the visibility of the events in "Upcoming events" page.
    ...
    # Check "online" Event visibility.
    Then I press "Reset"
    When I select "Online only" from "Format"
    And I wait for AJAX to finish
    Then the ".field-name-title" element should contain "online"
