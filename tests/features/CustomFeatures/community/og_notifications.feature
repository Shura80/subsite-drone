...
Feature: ENRD Notifications
  ...
  Background: I create a new Community and users working on it
    Given users:
      ...
      | bdd-admin | bdd-admin@example.com | test | authenticated user, administrator |
  ...
  Scenario: Notify new Community Member that he has been actively subscribed and Group admin about new membership.
    ...
    And the email to "bdd-admin@example.com" should contain "User Active joined BDD Community Notify"
  ...
  Scenario: Notify new Community Member that his subscription is pending for approval.
    ...
    And the email to "bdd-admin@example.com" should contain "User Pending membership request BDD Community Notify"
  ...
  Scenario: Notify new Community Member that his subscription has been approved and Group admin about new membership.
    ...
    And I am logged in as "bdd-admin"
    ...
    And the email to "bdd-admin@example.com" should contain "User Approved joined BDD Community Notify"
  ...
  Scenario: Notify new Community Member that his subscription has been rejected and Group admin about refusal.
    ...
    And the email to "bdd-admin@example.com" should contain "User Blocked blocked for BDD Community Notify"

  # Rule: ENRD OG member subscribe (Remove)
  @og @emails @notify_users @remove
  Scenario: Notify new Community Member that it has been removed from Group and admin about removal.
    Given I am logged in as a user with the "authenticated user" role and I have the following fields:
      | field_firstname | User                     |
    ...
    And the email to "bdd-admin@example.com" should contain "User Remove removed from BDD Community Notify"
