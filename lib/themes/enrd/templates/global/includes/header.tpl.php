...
<div id="layout-header">
  <div class="container">
    <div class="row" id="mobile-header-wrapper">
      <div class="col-lg-12 col-md-12 col-sm-12">
        <div id="mobile-header">
          <div id="main-menu-holder"><a href="#"><span class="glyphicon glyphicon-menu-hamburger"></span></a></div>
          <div id="user-menu-holder"></div>
          <div id="search-box-holder"><a href="#"><span class="glyphicon glyphicon-search"></span></a></div>
        </div>
      </div>
    </div>
  </div>
...
<div id="enrd-header" class="container">
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
      <div id="enrd-logo-header">
        <div id="enrd-logo-holder">
          <div class="enrd-hero-text"><?php print $site_slogan; ?></div>
          <a href="<?php print $front_page ?>" title="<?php print $site_name ?>">
            <img src="<?php print $logo; ?>" alt="<?php print t('ENRD logo'); ?>" id="enrd-logo">
          </a>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="region-featured-wrapper <?php print($has_responsive_sidebar ? 'sidebar-visible-sm' : ''); ?> hidden-xs">
