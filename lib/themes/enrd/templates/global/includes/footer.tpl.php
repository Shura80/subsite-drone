...
<div id="footer" class="container layout-footer">
  <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12 footerECSection">
          <p class="footerFundedBy"><?php print t('funded by'); ?></p>
          <img class="footerECLogo" src="<?php print base_path() . path_to_theme(); ?>/img/logo-ce-horizontal-en-quadri-lr.png" alt="<?php print t('European Commision logo'); ?>">
      </div>
