...
<div id="main" class="container">
  <div class="row">
    ...
    <div class="col-lg-<?php print $cols['content_main']['lg']; ?> col-md-<?php print $cols['content_main']['md']; ?> col-sm-<?php print $cols['content_main']['sm']; ?> col-xs-<?php print $cols['content_main']['xs']; ?> col-lg-push-<?php print ($cols['content_main_offset']['lg']); ?> col-md-push-<?php print ($cols['content_main_offset']['md']); ?>">
      <div class="row">

        <aside class="action-bar col-md-12 clearfix"  role="complementary">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <?php if ($title): ?>
            <h1 class="title sr-only" id="page-title"><?php print $title; ?></h1>
          <?php endif; ?>
      ...
      <div class="main-content clearfix">
        ...
        <div class="row">
          <div class="col-md-6">
            <?php if ($regions['focus']): ?>
              <?php print $regions['focus']; ?>
            <?php endif; ?>
          </div>
          <div class="col-md-6">
