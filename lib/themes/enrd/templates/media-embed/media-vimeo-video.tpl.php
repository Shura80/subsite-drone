...
?>
<?php if (!$no_wrapper): ?>
    <div class="<?php print $classes; ?> media-vimeo-<?php print $id; ?> embed-responsive embed-responsive-16by9">
<?php endif; ?>
        <iframe class="media-vimeo-player embed-responsive-item"
                <?php print $api_id_attribute; ?>width="<?php print $width; ?>"
                height="<?php print $height; ?>" title="<?php print $title; ?>"
                src="<?php print $ec_embedded_video_url; ?>" frameborder="0"
                allowfullscreen><?php print $alternative_content; ?></iframe>
<?php if (!$no_wrapper): ?>
    </div>
<?php endif; ?>
