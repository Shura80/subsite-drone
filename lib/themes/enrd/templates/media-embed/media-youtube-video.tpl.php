...
?>
<?php if (!$no_wrapper): ?>
    <div class="<?php print $classes; ?> media-youtube-<?php print $id; ?> embed-responsive embed-responsive-16by9">
<?php endif; ?>

    <iframe class="media-youtube-player embed-responsive-item" <?php print $api_id_attribute; ?>
