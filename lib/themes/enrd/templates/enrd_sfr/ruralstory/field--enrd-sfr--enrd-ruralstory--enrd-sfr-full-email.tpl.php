...
/**
 * @file
 * Template to display an ENRD Sfr Ruralstory "Full e-mail" field.
 *
 * Available variables:
...
?>
<p>
<?php if (!$label_hidden): ?><?php print $label ?>: <?php
endif; ?><?php foreach ($items as $delta => $item): ?><?php print render($item); ?><?php
endforeach; ?>
</p>
