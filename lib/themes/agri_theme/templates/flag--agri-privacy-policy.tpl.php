...
/**
 * @file
 * Theme implementation to display a flag link, its id & a message post action.
 *
 * Available variables:
 *
 ...
 *   to the link.
 * - $flag_id: The Flag id that is used as reference for anchoring purposes.
 *
...
<span class="<?php print $flag_wrapper_classes; ?>">
  <?php if ($link_href): ?>
    <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" id="<?php print $flag_id; ?>" class="<?php print $flag_classes; ?>" rel="nofollow"><?php print $link_text; ?></a><span class="flag-throbber"></span>
  <?php else: ?>
